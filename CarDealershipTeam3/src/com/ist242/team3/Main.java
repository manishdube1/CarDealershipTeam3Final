...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        final String PROMPT_ACTION = "Dealership Info(D),Add Customer (C), Print Customer (P), Order Car (Q), Order Part (A), List Transaction (T) , List Vehicle (V), List Parts (I), Add SalesPerson (S), Print SalesPerson(s) (J), or Exit (E)";
        ...
        dealership dealership = new dealership("1007 Arlene Court","610-873-2312","billsautos@gmail.com","Monday-Friday(9am to 7 pm)Sat-Sun(10am- 7pm");
        Order order1 = new Order(1,0,0,0);
...
// case ORDE_PRNT:
                ...
                case TRAN_CODE:
                    ...
                    break;
                case DEAL_INFO:
                    System.out.println("Address:1007 Arlene Court,Phone Number: 610-873-2312, Email:billsautos@gmail.com,Hours:Monday-Friday(9am to 7 pm)Sat-Sun(10am- 7pm");
                    dealership.dealInfo(dlist);
                    break;
            }
